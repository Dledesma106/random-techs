...
import { IBranch, IActivity, IClient } from "../../models/interfaces";
  ...
  return (
    <>
      <View className={card}>
        ...
        <TouchableOpacity className="flex justify-center items-center text-center" onPress={toggleFormVisibility}>
